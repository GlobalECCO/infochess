    ...
    Tutorial.prototype.initTutorialSteps = function() {
      self.script = [
        ...
        [{
          ...
          tip: {
            title: 'InfoChess',
            content: 'InfoChess plays like a standard game of chess, with the addition of invisible pieces and information warfare attacks.  The goal is still to take your opponent\'s king, but both players have limited information to operate on.',
            tipJoint: 'left',
            stemLength: 0,
            offset: [0, 100],
          },
        ...
        [{
          ...
          tip: {
            title: 'Pawn Capture',
            content: 'This button lets you see if any of your pawns are able to capture invisible enemy pieces.  If they can, you must move one of those pawns this turn.  Otherwise, you are free to move any piece as normal.',
            tipJoint: 'bottom',
          },
          action: null,
        },
        ...
        // Step 18
        [{
          el: '[class^="knight_"].normal_piece',
          tip: {
            content: 'Click on your knight to move it.',
            tipJoint: 'bottom',
          },
        }],

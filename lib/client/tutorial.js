define(['underscore', 'lib/infochess'], function(_, InfoChess) {
    ...
    self.serverHandlers = [
      {
        ...
        handler: function(data) {
          return self.InfoChess.move(self.role, new Position(data.src.x, data.src.y), new Position(data.dest.x, data.dest.y));
        },
      },
    ];
  }

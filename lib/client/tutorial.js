      ...
      self.script = [
        ...
        [{
          ...
          tip: {
            ...
            content: 'In Info Chess, you only get a subset of the pieces you get in a standard game of chess.  You have 10 points to spend on building pieces for your side.',
            tipJoint: 'right',
            offset: [30, 0],
          },
          action: null,
...

        {
          ...
          tip: {
            title: 'King',
            content: 'You must place one King on the board.  Kings are invisible to the other player unless they capture a piece or move into the last three rows.',
            tipJoint: 'right',
          },
          action: null,
        },
        ...
        [{
          ...
          tip: {
            title: 'King Movement',
            content: 'A King can move one space in any direction as illustrated here: *picture*',
            tipJoint: 'right',
          },
          action: null,
        },
        ...
        [{
          ...
          tip: {
            title: 'Queen',
            content: 'A Queen costs 3 points to build and you can only start with 1 on the board.',
            tipJoint: 'right',
          },
          action: null,
        },
        ...
        [{
          ...
          tip: {
            ...
            content: 'A Queen can move any number of spaces diagonally or orthogonally as illustrated here: *picture*',
            tipJoint: 'right',
          },
          action: null,
        },
        ...
        [{
          ...
          tip: {
            title: 'Knight',
            content: 'A Knight costs 2 points to build and you can have 2 at most on the board.  Knights are invisible to the other player unless they capture a piece or move into the last three rows.',
            tipJoint: 'right',
          },
          action: null,
        },
        ...
        [{
          ...
          tip: {
            ...
            content: 'A Knight moves two squares in any orthogonal direction and then 1 space in either perpendicular direction as illustrated here: *picture*',
            tipJoint: 'right',
          },
          action: null,
        },
        ...
        [{
          ...
          tip: {
            title: 'Rook',
            content: 'A Rook costs 2 points to build and you can have 2 at most on the board.',
            tipJoint: 'right',
          },
          action: null,
        },
        ...
        [{
          ...
          tip: {
            title: 'Rook Movement',
            content: 'A Rook can move any number of spaces orthogonally as illustrated here: *picture*',
            tipJoint: 'right',
          },
          action: null,
        },
        ...
        [{
          ...
          tip: {
            title: 'Pawn',
            content: 'A Pawn costs 1 point to build and you can have 8 at most on the board.  Pawns are invisible to the other player unless they capture a piece or move into the last three rows.',
            tipJoint: 'right',
          },
          action: null,
        },
        ...
        [{
          ...
          tip: {
            title: 'Pawn Movement',
            content: 'A Pawn can move forward one space (or two if it\'s the Pawn\'s first move) if it is unoccupied as illustrated here: *picture*.<br>' +
                     '<br>A Pawn can capture a piece if it is diagonally in front of the Pawn as illustrated here: *picture*',
            tipJoint: 'right',
          },
          action: null,
        },
        ...
        [{
          ...
          tip: {
            title: 'Bishop',
            content: 'A Bishop costs 1 point to build and you can have 2 at most on the board.',
            tipJoint: 'right',
          },
          action: null,
        },
        ...
        [{
          ...
          tip: {
            ...
            content: 'A Bishop can move any number of spaces diagonally as illustrated here: *picture*',
            tipJoint: 'right',
          },
          action: null,
        },
        ...
        [{
          ...
          tip: {
            title: 'Pawn Capture',
            content: 'This button lets you see if any of your pawns are able to capture invisible enemy pieces.  If they can, you must move one of those pawns this turn.',
            tipJoint: 'bottom',
          },
          action: null,
        },
...

        {
          ...
          tip: {
            content: 'Every turn, you must move a piece on the board.  Select your Pawn now to move it.',
            tipJoint: 'bottom',
          },
        }],
        ...
        [{
          el: '#action_selector',
          tip: {
            title: 'Information Warfare Attack',
            content: 'After moving a piece, as long as you have Information Warfare (IW) points available, you may attack the other player with either an Electronic Warfare or Psyops attack.',
            tipJoint: 'right',
            offset: [-35, -190],
          },
          action: null,
...

        {
          ...
          tip: {
            title: 'Attack Points',
            content: 'You can see how many points you have left for each attack type here.',
            tipJoint: 'top',
            stemLength: 35,
            offset: [0, -15],
          },
...

        {
          ...
          tip: {
            title: 'Cost Cycle',
            content: 'IW attack costs cycle between cheap and expensive each time they are used by either player.  On a cheap cycle, a normal attack costs 1, a reinforced attack costs 2, a feint attack cannot be used, and defending it costs 2.  On an expensive cycle, a normal attack costs 2, a reinforced attack costs 3, a feint attack costs 1, and defending it costs 1.',
            tipJoint: 'top',
            stemLength: 25,
          },
          action: null,
        ...
        [{
          ...
          tip: {
            ...
            content: 'An Electronic Warfare attack prevents the other player from moving their pieces on the board next turn.  They may still use an IW attack, if they choose.',
            tipJoint: 'right',
            stemLength: 315,
            offset: [35, -65],
          },
...

        {
          ...
          tip: {
            title: 'Psyops Attack',
            content: 'A Pysops attack will remove one of your opponent\'s pieces from the board.  If they have any Pawns, it will remove the one furthest from their King.  Otherwise, if they have any non-King piece, it will remove the furthest one from their King.  Otherwise, it will remove their King from the board and you will win the game.',
            tipJoint: 'right',
            stemLength: 330,
            offset: [50, -65],
          },
        ...
        {
          el: '#ew_normal, #psyop_normal',
          tip: {
            title: 'Normal Attack',
            content: 'Each IW attack has a strength.  A normal attack can be defended against using points of the same type.  If defended, the attack will have no effect.',
            tipJoint: 'bottom'
          },
          action: null,
        },
        ...
        {
          el: '#ew_reinforced, #psyop_reinforced',
          tip: {
            title: 'Reinforced Attack',
            content: 'A reinforced attack will have an effect on the opponent whether they defend it or not.  If defended, your opponent will have wasted their points.',
            tipJoint: 'right'
          },
          action: null,
        },
        ...
        {
          el: '#ew_feint, #psyop_feint',
          tip: {
            title: 'Feint Attack',
            content: 'A feint attack will never have an effect on your opponent, however, it will look like any other attack, so they might waste their points trying to defend against it.',
            tipJoint: 'top',
            stemLength: 70,
          },
          action: null,
...

        {
          ...
          tip: {
            title: 'End Turn',
            content: 'You can click here if you want to end your turn without making an IW attack.',
            tipJoint: 'right'
          },
          action: null,
        },
...

        {
          ...
          tip: {
            title: 'Offer a Draw',
            content: 'If the game seems to be a stalemate, you can always offer you opponent a draw to end the game with no winner or loser.',
            tipJoint: 'right'
          },
          action: null,
        },

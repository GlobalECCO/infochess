...
InfoChess.prototype.startGame = function() {
  ...
  this.addHistory(this.HISTORY_TYPES.GAME_STARTED, "Game started. It is white's move.");
};
...
InfoChess.prototype.notifyNewTurn = function(role) {
  this.addHistory(this.HISTORY_TYPES.TURN_STARTED, "Turn #" + this.turn_count + " started.  It is " + role + "'s move.");
};

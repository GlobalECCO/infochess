  ...
  var obj =
    {psyop : {
      normal: {
        ignored: {
          attacker: {
            line1:'Psyop Attack Ignored', line2:"Captured Opponent's Piece!", outcome:'win'
          },
          defender: {
      ...
      reinforced: {
        ignored: {
          attacker: {
            line1:'Reinforced Psyop Attack Ignored', line2:"Captured Opponent's Piece!", outcome:'win'
          },
          defender: {
            line1:'Psyop Attack Undefended', line2:'Piece Captured by Opponent', outcome:'lose'
          }
      ...
      feint: {
        ignored: {
          attacker: {
            line1:'Psyop Feint Attack Ignored', line2:'No Effect!', outcome: 'lose'
          },
          defender: {
    ...
    ew : {
      normal: {
        ignored: {
          attacker: {
            line1:'E-Warfare Attack Ignored', line2:'Opponent Immobilized!', outcome:'win'
          },
          defender: {
      ...
      reinforced: {
        ignored: {
          attacker: {
            line1:'Reinforced E-Warfare Attack Ignored', line2:'Opponent Immobilized!', outcome: 'win'
          },
          defender: {
            line1:'E-Warfare Attack Undefended', line2:'Pieces Immobilized by Opponent', outcome: 'lose'
          }
      ...
      feint: {
        ignored: {
          attacker: {
            line1:'E-Warfare Feint Attack Ignored', line2:'No Effect!', outcome:'lose'
          },
          defender: {
